%let pgm=utl-altair-slc-supplementing-rapid-miner-with-genetic-modeling-using-r-ga-package;

%stop_submission;

altair slc supplementing rapid miner with genetic modeling using r ga package

Too long to post on a list, see github
https://github.com/rogerjdeangelis/utl-altair-slc-supplementing-rapid-miner-with-genetic-modeling-using-r-ga-package
